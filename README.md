...
| `vibe-sait` | Собирает сайт по каркасу ниши: бриф → каркас и вариант → картинки kie.ai (или заглушки) → скриншоты → правки словами. Нужны Node.js 20+, Chrome и свой ключ kie.ai | Д2.2–Д2.3 |
