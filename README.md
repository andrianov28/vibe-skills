...
После включения в новом чате скажи «настрой сборку сайтов»: скилл сам поставит пакеты для скриншотов и картинок в папку ~/.vibe/build, найдёт Chrome и спросит ключ kie.ai (свой у каждого; без ключа сайты собираются на заглушках).
